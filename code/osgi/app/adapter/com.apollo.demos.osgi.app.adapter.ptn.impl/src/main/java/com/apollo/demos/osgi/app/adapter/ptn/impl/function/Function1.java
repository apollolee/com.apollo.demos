...
import static com.apollo.demos.osgi.app.adapter.ptn.api.IPtnAdapterConstants.ComponentName.Processor3;
...
public class Function1 extends PtnBaseFunction {

    @Reference(target = ProcessorPrefix + Processor2 + ")")
    @Processor(order = 2)
    protected volatile ComponentFactory processor2;

    @Reference(target = ProcessorPrefix + Processor3 + ")")
    @Processor(order = 3)
    protected volatile ComponentFactory processor3;
