...
@Service
public class Processor5 implements IProcessor {

    private static final Logger s_logger = LoggerFactory.getLogger(Processor5.class);

    @Override
    public void execute(ProcessData processData) {
        s_logger.info("Execute. [{}#{}]", showId(this), processData);

        processData.put("temp", processData.get("temp") + " ; Processor5");
    }
