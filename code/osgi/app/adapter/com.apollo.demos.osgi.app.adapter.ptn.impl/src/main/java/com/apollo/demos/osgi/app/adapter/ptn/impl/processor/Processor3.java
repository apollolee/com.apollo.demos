...
@Service
public class Processor3 implements IProcessor {

    private static final Logger s_logger = LoggerFactory.getLogger(Processor3.class);

    @Override
    public void execute(ProcessData processData) {
        s_logger.info("Execute. [{}#{}]", showId(this), processData);

        processData.put("temp", processData.get("temp") + " ; Processor3");
    }
