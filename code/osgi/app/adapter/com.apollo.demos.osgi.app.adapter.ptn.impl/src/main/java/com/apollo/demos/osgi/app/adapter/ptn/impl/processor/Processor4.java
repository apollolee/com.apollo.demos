...
@Service
public class Processor4 implements IProcessor {

    private static final Logger s_logger = LoggerFactory.getLogger(Processor4.class);

    @Override
    public void execute(ProcessData processData) {
        s_logger.info("Execute. [{}#{}]", showId(this), processData);

        processData.put("temp", processData.get("temp") + " ; Processor4");
    }
